...
Label(window,text="MOUNTAIN MIRAGE RESORT",font=('Alegreya sans',15,'bold'),bg='white').place(x=910,y=270)
Label(window,text="Dulikhel, Kathmandu",font=('Times',14,),bg='white').place(x=967,y=295)
Label(window,text="Phone: 9840922949, 9860003782",font=('Times',10),bg='white').place(x=965,y=320)
